...
(function($) {
    var defaults = {
        ...
        rootClass:'potato-menu2',
        menuItemClass:'potato-menu-item2',
        menuGroupClass:'potato-menu-group2',
        verticalClass:'potato-menu-vertical2',
        holizontalClass:'potato-menu-holizontal2',
        hasVerticalClass:'potato-menu-has-vertical2',
        hasHolizontalClass:'potato-menu-has-holizontal2',
        hoverClass:'potato-menu-hover2',
        showDuration: 350,
        hideDuration: 100
    }
    function menu() {
