...
/*
  ...
  */ 
   ...
   String filePath = context.getInitParameter("newsletter-upload");
   ...
   if ((contentType.indexOf("multipart/form-data") >= 0)) {
      ...
      try {
         ...
         while (i.hasNext()) {
            ...
            if (!fi.isFormField()) {
               if (fi.getContentType().equalsIgnoreCase("application/pdf")) {
                  ...
                  out.print("O ficheiro é invalido! <br/> As extensões permitidas são: .pdf <br/><br/><br/> Faça voltar no browser para alterar o ficheiro!");
               }
            }
         }
         out.println("</body>");
