    ...
    var methods = {
        ...
        _validateFields: function(form, skipAjaxFieldValidation) {
            ...
            if (errorFound) {
                if (options.scroll) {
                    ...
                    //var destination = form.find(".formError:not('.greenPopup'):last").offset().top;
        ...
        _validateFormWithAjax: function(form, options) {
            ...
            $.ajax({
                ...
                cache: false,
                dataType: form.attr("tipoDados"),//ALTERADO NUNO
                data: data,
                form: form,
                methods: methods,
                options: options,
        ...
        _validateField: function(field, options, skipAjaxFieldValidation) {
            ...
            if ((fieldType == "radio" || fieldType == "checkbox") && $("input[name='" + fieldName + "']").size() > 1) {
                field = $($("input[name='" + fieldName + "'][type!=hidden]:last"));
        ...
        _buildPrompt: function(field, promptText, type, ajaxed, options) {
            ...
            return prompt.animate({
                ...
                setTimeout(function(){
                    prompt.fadeTo("fast", 0.7, function() {
                        $(this).remove();
                    });
